...
function addItem(e) {
    ...
    var item_action = document.createElement("div");
    item_action.classList.add("actions");
    var edit_item = document.createElement("button");
    ...
    input.value = "";
    edit_item.addEventListener("click", function (e) {
